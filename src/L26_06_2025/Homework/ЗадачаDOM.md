...
**Цель**: Используя JavaScript, сделать страницу `card.html` интерактивной,
добавив функциональность для кнопки "Связаться" и динамическое изменение содержимого карточки пользователя.
