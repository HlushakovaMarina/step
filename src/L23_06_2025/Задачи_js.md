...
```  
Измените `year` на `2022` и добавьте новое поле `color` 
со значением `"синий"`. Выведите обновленный объект.  
...
которая принимает объект и возвращает количество его свойств.  
...
Напишите цикл `for`, который выводит числа от `1` до `N` 
...
выведите все ключи и их значения в формате:  
```
title: JavaScript для начинающих  
author: Иван Петров  
pages: 200  
...
```  
Напишите цикл `for`, 
который выводит имена студентов из группы `"ПИ-101"`.  
